...
% GPVAR/POWER  Implements '.^' for GP variable.
%
...
% take the pointwise power with a GP var and a scalar (to get a monomial)
...
% pointwise power of GP vector (or matrix) and scalar power
if( length(obj2) == 1 )
  for i = 1:sz1(1)
    for j = 1:sz1(2)
      r(i,j) = obj1(i,j)^obj2;
...
% pointwise power of a GP var vector and a scalar vector
if( sz1(1) == 1 & sz2(1) == 1 )
  for k = 1:sz1(2)
...
% pointwise power of matrices (one has GP variables and the other scalars)
for i = 1:sz1(1)
  for j = 1:sz1(2)
