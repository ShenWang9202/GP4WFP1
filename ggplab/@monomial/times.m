...
% multiplying two monomials together (to get a monomial)
if( length(obj1) == 1 & length(obj2) == 1 )
  r = monomial(obj1)*monomial(obj2);
  return;
end

% pointwise product of two monomial vectors (to get another monomial vector)
if( sz1(1) == 1 & sz2(1) == 1 )
  for k = 1:sz1(2)
...
% multiplying out matrices of monomials
for i = 1:sz1(1)
  for j = 1:sz1(2)
